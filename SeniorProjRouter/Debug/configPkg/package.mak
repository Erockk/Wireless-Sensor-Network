...
.dlls,em3 .dlls: SeniorProjGPS.pem3

-include package/cfg/SeniorProjGPS_pem3.mak
-include package/cfg/SeniorProjGPS_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/SeniorProjGPS_pem3.dep
endif
SeniorProjGPS.pem3: package/cfg/SeniorProjGPS_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
SeniorProjGPS.pem3 package/cfg/SeniorProjGPS_pem3.c: .libraries,em3
endif

package/cfg/SeniorProjGPS_pem3.c package/cfg/SeniorProjGPS_pem3.h package/cfg/SeniorProjGPS_pem3.xdl: override _PROG_NAME := SeniorProjGPS.xem3
package/cfg/SeniorProjGPS_pem3.c: package/cfg/SeniorProjGPS_pem3.cfg
package/cfg/SeniorProjGPS_pem3.xdc.inc: package/cfg/SeniorProjGPS_pem3.xdl
package/cfg/SeniorProjGPS_pem3.xdl package/cfg/SeniorProjGPS_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/SeniorProjGPS_pem3.cfg
	-$(RM) package/cfg/SeniorProjGPS_pem3.dep
	-$(RM) package/cfg/SeniorProjGPS_pem3.c
	-$(RM) package/cfg/SeniorProjGPS_pem3.xdc.inc

clean,em3::
	-$(RM) SeniorProjGPS.pem3
.executables,em3 .executables: SeniorProjGPS.xem3

SeniorProjGPS.xem3: |SeniorProjGPS.pem3

-include package/cfg/SeniorProjGPS.xem3.mak
SeniorProjGPS.xem3: package/cfg/SeniorProjGPS_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/SeniorProjGPS_pem3.oem3   package/cfg/SeniorProjGPS_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
SeniorProjGPS.xem3: export C_DIR=
SeniorProjGPS.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
SeniorProjGPS.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

SeniorProjGPS.test test,em3 test: SeniorProjGPS.xem3.test

SeniorProjGPS.xem3.test:: SeniorProjGPS.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 SeniorProjGPS.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.SeniorProjGPS.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,SeniorProjGPS.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) SeniorProjGPS.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
SeniorProjGPS_pem3.oem3,copy : package/cfg/SeniorProjGPS_pem3.oem3
SeniorProjGPS_pem3.sem3,copy : package/cfg/SeniorProjGPS_pem3.sem3
