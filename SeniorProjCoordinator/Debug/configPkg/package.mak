...
.dlls,em3 .dlls: SeniorProj.pem3

-include package/cfg/SeniorProj_pem3.mak
-include package/cfg/SeniorProj_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/SeniorProj_pem3.dep
endif
SeniorProj.pem3: package/cfg/SeniorProj_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
SeniorProj.pem3 package/cfg/SeniorProj_pem3.c: .libraries,em3
endif

package/cfg/SeniorProj_pem3.c package/cfg/SeniorProj_pem3.h package/cfg/SeniorProj_pem3.xdl: override _PROG_NAME := SeniorProj.xem3
package/cfg/SeniorProj_pem3.c: package/cfg/SeniorProj_pem3.cfg
package/cfg/SeniorProj_pem3.xdc.inc: package/cfg/SeniorProj_pem3.xdl
package/cfg/SeniorProj_pem3.xdl package/cfg/SeniorProj_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/SeniorProj_pem3.cfg
	-$(RM) package/cfg/SeniorProj_pem3.dep
	-$(RM) package/cfg/SeniorProj_pem3.c
	-$(RM) package/cfg/SeniorProj_pem3.xdc.inc

clean,em3::
	-$(RM) SeniorProj.pem3
.executables,em3 .executables: SeniorProj.xem3

SeniorProj.xem3: |SeniorProj.pem3

-include package/cfg/SeniorProj.xem3.mak
SeniorProj.xem3: package/cfg/SeniorProj_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/SeniorProj_pem3.oem3   package/cfg/SeniorProj_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
SeniorProj.xem3: export C_DIR=
SeniorProj.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
SeniorProj.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

SeniorProj.test test,em3 test: SeniorProj.xem3.test

SeniorProj.xem3.test:: SeniorProj.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 SeniorProj.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.SeniorProj.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,SeniorProj.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
SeniorProj_pem3.oem3,copy : package/cfg/SeniorProj_pem3.oem3
SeniorProj_pem3.sem3,copy : package/cfg/SeniorProj_pem3.sem3
